...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <!-- <span class="brand-text font-weight-light">Food Donation</span> -->
      <h2><span><b>Food Bank</b> </span><p style="color:cream; font-size:15px; margin-left:5px;">Feed More, Waste Less</p></h2>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin/foods" class="nav-link {{Request::is('admin/foods')?'active' : '' }}">
