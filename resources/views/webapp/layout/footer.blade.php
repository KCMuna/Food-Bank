...
<footer class="first-footer">
                            ...
                            <ul>
                                <li>
                                    <div class="info">
                                        ...
                                        <p class="in-p">Thapathali, Kathmandu</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="info">
                                        <i class="fa fa-phone" aria-hidden="true"></i>
                                        <p class="in-p"><a href="tel:+456 875 369 208">+456 875 369 208</a></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="info">
                                        <i class="fa fa-envelope" aria-hidden="true"></i>
                                        <p class="in-p ti"><a href="mailto:innovativegrocery2021@gmail.com">foodbank2022@gmail.com</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="second-footer">
            <div class="container">
                ...
                <p>Food Bank ©<script>document.write(new Date().getFullYear());</script> All rights reserved. </p>
                <ul class="netsocials">
...
<!-- Bootstrap4 Duallistbox -->
   ...
   <script src="/admin-assets/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
    ...
    <script>
        ...
        $('.select2').select2();
        $(".select2").select2({ dropdownCssClass: "myOption" });
